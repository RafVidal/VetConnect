    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">VetConnect<sup>VET</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/vet/pets">
                    <i class="fas fa-paw"></i>
                    <span>Pet's</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/vet/cartao_de_vacinacao">
                    <i class="fas fa-paste"></i>
                    <span>Cartões de Vacinas</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/vet/vacina">
                    <i class="fas fa-syringe"></i>
                    <span>Vacinas</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/vet/medicacao">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="vet/#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{auth()->user()->veterinario->nome}}</span>
