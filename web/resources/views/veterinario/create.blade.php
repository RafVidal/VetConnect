...
<form action="{{ route('adm.veterinario.store') }}" method="POST" class="container was-validated" novalidate="" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="form-row col-xs-12 col-sm-12 col-md-12">
            <div style="margin-left: 6px;" class="form-group col-md-6">
                ...
                <label class="custom-file-label" for="img_vet">Escolha uma foto do veterinário</label>
            </div>
        </div>
